...
local wb_textbox = require("wibox.widget.textbox")
...
beautiful.init("/opt/awesome/share/awesome/themes/default/theme.lua")
...
mywidgets[#mywidgets + 1] = cpuwidget

-- Memory
memwidget = wibox.widget.textbox()
vicious.register(memwidget, vicious.widgets.mem, "MEM: $1% ($2MB/$3MB) <b>|</b> ", 13)
mywidgets[#mywidgets + 1] = memwidget

-- Battery
batwidget = wb_textbox()
vicious.register(batwidget,vicious.contrib.my_bat_sysclass,
    function (widget,args)
    local ratecolor = 'white'
...
mywidgets[#mywidgets + 1] = batwidget
--]]
...
for s = 1, screen.count() do
    ...
    if s == 1 then
        for k, w in ipairs(mywidgets) do
            right_layout:add(w)
        end
    end
